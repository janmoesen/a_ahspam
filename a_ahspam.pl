...
sub a_ahspam_process_message {
	...
	return unless $msg =~ m/\b(ash|bash|brash|cache|cash|clash|crash|dash|flash|gash|gnash|hache|hash|lash|mash|rash|sash|slash|splash|stache|stash|thrash|trash)\b/i;
